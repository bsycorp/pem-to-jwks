...
func readKey(filename string) ([]byte, error) {
	...
	//because json serialisation removes empty string values
	result, err := json.MarshalIndent(keyResponse, "", "    ")
	return bytes.Replace(result, []byte("empty-key-id"), []byte(""), 2), nil
}
